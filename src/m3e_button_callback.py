...
def main():
    ...
    # button_name['command'] = function to run when the button is pressed
    print_stuff_button['command'] = (lambda: do_stuff())
    # lambda can only call other functions
    # without assigning lambda, the function being called runs first, and if something is returned, it is assigned to
    # the print_stuff_button['command']
